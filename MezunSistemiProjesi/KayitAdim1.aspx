<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KayitAdim1.aspx.cs" Inherits="MezunSistemiProjesi.KayitAdim1" %>
    ...
    <form runat="server">
        ...
        <div class="panel panel-default text-center" >
            <h3 style="color:#3eaea8 ">Lütfen Bilgilerinizi Adımları Takip Ederek Giriniz.</h3>
             ...
             <h1 style="color:#3eaea8 ">1.Adım</h1>
          ...
          <div class="panel-body">
              ...
              <div class="col-md-4">
                   <h4 style="color:#3eaea8 ">Doğum Tarihiniz:</h4>
              </div>
               <div class="col-md-8">
                    <asp:TextBox ID="TextBoxDogumTarihi" CssClass=" form-control datepicker" runat="server"></asp:TextBox>
               </div>
              </div>
              <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxDogumTarihi" Display="Dynamic" ErrorMessage="Doldurulmadan İlerlenemez Geç Diyerek Daha Sonra Doldurabilirisiniz." ForeColor="#FF0066" ValidationGroup="ileri"></asp:RequiredFieldValidator>
              <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="TextBoxDogumTarihi" Display="Dynamic" ErrorMessage="Lütfen Geçerli Bir Tarih Giriniz" ForeColor="#FF0066" Type="Date" ValidationGroup="ileri"></asp:RangeValidator>
              <br />
          <div class="row">
              <div class="col-md-3">
                  <asp:LinkButton ID="LinkButtonGec" CssClass="btn btn-danger" runat="server" OnClick="LinkButtonGec_Click">Geç <i class="fa fa-fw fa-times-circle"></i></asp:LinkButton>
              ...
              <div class="col-md-6"> 
               ...
               <div class="col-md-3">
                   <asp:LinkButton ID="LinkButtonIleri"  CssClass="btn btn-primary" ValidationGroup="ileri" runat="server" OnClick="LinkButtonIleri_Click">İleri <i class="fa fa-fw fa-arrow-circle-right"></i> </asp:LinkButton>
