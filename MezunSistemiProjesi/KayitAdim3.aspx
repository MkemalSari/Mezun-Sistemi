<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KayitAdim3.aspx.cs" Inherits="MezunSistemiProjesi.KayitAdim3" %>
    ...
    <form runat="server">
        ...
        <div class="panel panel-default text-center" >
            <h3 style="color:#3eaea8 ">Lütfen Bilgilerinizi Adımları Takip Ederek Giriniz.</h3>
             ...
             <h1 style="color:#3eaea8 ">3.Adım</h1>
          ...
          <div class="panel-body"><div class="progress">
              ...
              <div class="col-md-4">
                   <h3 style="color:#3eaea8 ">Cinsiyetiniz:</h3>
              </div>
               <div class="col-md-4">
                   <asp:LinkButton ID="LinkButton1Erkek"  runat="server" OnClick="LinkButton1Erkek_Click"><asp:Image CssClass="img-circle"  Width="70px" ID="Image2" ImageUrl="~/image/Man.jpg" runat="server" /></asp:LinkButton>
                    
                 
               </div>
                  <div class="col-md-4">
                  <asp:LinkButton ID="LinkButtonKadin"  runat="server" OnClientClick="myfunction(); return false;" OnClick="LinkButtonKadin_Click"> <asp:Image CssClass="img-circle"  Width="70px" ID="Image1" ImageUrl="~/image/Woman.jpg" runat="server" /></asp:LinkButton>
                      
               </div>

              </div>
               <asp:Label ID="Label1" runat="server" ForeColor="#FF0066" Text="Lütfen Bir Seçim Yapınız!" Visible="False"></asp:Label>
              <br />
          <div class="row">
              <div class="col-md-3">
              ...
              <div class="col-md-6"> 
               ...
               <div class="col-md-3">
                   <asp:LinkButton ID="LinkButton1ilerii" CssClass="btn btn-primary" runat="server" OnClick="LinkButton1ilerii_Click">İleri1 <i class="fa fa-fw fa-arrow-circle-right"></i></asp:LinkButton>
